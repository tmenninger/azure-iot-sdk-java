...
public final class DeviceClient implements Closeable
{
    ...
    private final static String SET_SEND_INTERVAL = "SetSendInterval";
    private final static String SET_CERTIFICATE_PATH = "SetCertificatePath";
    private final static String SET_SAS_TOKEN_EXPIRY_TIME = "SetSASTokenExpiryTime";
